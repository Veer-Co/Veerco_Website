...
INSERT INTO `addresses` (`id`, `userid`, `fname`, `lname`, `email`, `mobile`, `locationName`, `townName`, `city`, `state`, `country`, `pincode`, `address_status`, `created_at`, `updated_at`) VALUES
(1, '1', 'swapnil', 'shinde', 'swapnilshinde9382@gmail.com', '9382084913', '7hills mantra, kolhewadi, pune', 'kolhewadi', 'pune', 'Maharashtra', 'India', '411024', 2, '2023-05-22 09:34:23', NULL);
...
CREATE TABLE `bought_together_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `orders` (`id`, `userid`, `fname`, `lname`, `email`, `mobile`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `total_amount`, `status`, `payment_mode`, `message`, `tracking_no`, `shipping_date`, `delivered_date`, `created_at`, `updated_at`) VALUES
(1, '1', 'swapnil', 'shinde', 'swapnilshinde9382@gmail.com', '9382084913', '7hills mantra, kolhewadi, pune', 'kolhewadi', 'pune', 'Maharashtra', 'India', '411024', 9822.00, 0, 'cash', NULL, NULL, NULL, NULL, '2023-05-22 15:04:25', '2023-05-22 15:04:25');
...
(1, '1', 'P00012', '1', 3274.00, '2023-05-22 15:04:25', '2023-05-22 15:04:25'),
(2, '1', 'P00011', '1', 3274.00, '2023-05-22 15:04:25', '2023-05-22 15:04:25'),
(3, '1', 'P00015', '1', 3274.00, '2023-05-22 15:04:25', '2023-05-22 15:04:25');
...
CREATE TABLE `promocode_releted_customers` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `promocode_releted_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `promocode_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `product_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `up_selling_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `pro_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `mobile`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'swapnil', 'shinde', '9382084913', 'swapnilshinde9382@gmail.com', NULL, '$2y$10$MMZ.TLz1sBXwL/VAjzNMp.QuJOdOEkSy0eic07NPTfkWkHYoeW2Wy', NULL, '2023-05-22 15:04:23', '2023-05-22 15:04:23');
...
--
-- Indexes for table `bought_together_products`
--
ALTER TABLE `bought_together_products`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `promocode_releted_customers`
--
ALTER TABLE `promocode_releted_customers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `promocode_releted_products`
--
ALTER TABLE `promocode_releted_products`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `up_selling_products`
--
ALTER TABLE `up_selling_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bought_together_products`
--
ALTER TABLE `bought_together_products`
...
--
-- AUTO_INCREMENT for table `promocode_releted_customers`
--
ALTER TABLE `promocode_releted_customers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `promocode_releted_products`
--
ALTER TABLE `promocode_releted_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `up_selling_products`
--
ALTER TABLE `up_selling_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
